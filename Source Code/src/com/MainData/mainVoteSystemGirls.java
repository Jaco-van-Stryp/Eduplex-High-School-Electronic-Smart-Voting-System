...
//NOTE
//THERE ARE 3 CLASSES FOR EACH GENDER, REFERENCE TO COMMENTS ON THE mainVoteSystemBoys CLASS AS ITS ONLY THE GENDER TYPES THAT CHANGE IN SQL STATEMENTS
...
public class mainVoteSystemGirls extends javax.swing.JFrame {
    ...
    String score;
    boolean secondVote = false;
    MultiVote mv = new MultiVote();
    int votesAllowed;

    public mainVoteSystemGirls() {
        if (cm.usedFirstVote() == false) {
            votesAllowed = Integer.parseInt(cm.getGradeData(cm.loadGradeData(), "g", "1"));//The total votes allowed (will be read from the settings file)

            score = mv.getMultiVoteSettings(grade, "VoteOnePoints");
            grade = cm.getFirstVote(grade);

        } else {
            votesAllowed = Integer.parseInt(cm.getGradeData(cm.loadGradeData(), "g", "2"));//The total votes allowed (will be read from the settings file)
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 7, -1, 19));

        jLabel21.setBackground(new java.awt.Color(255, 255, 255));
        jLabel21.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(255, 255, 255));
        jLabel21.setText("Click On The Person");
        jPanel2.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 37, -1, 19));

        jLabel22.setBackground(new java.awt.Color(255, 255, 255));
        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("If You Wish To Change");
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 62, -1, 19));

        jLabel23.setBackground(new java.awt.Color(255, 255, 255));
        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(255, 255, 255));
        jLabel23.setText("Your selection, Click on");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 92, -1, 19));

        jLabel25.setBackground(new java.awt.Color(255, 255, 255));
        jLabel25.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(255, 255, 255));
        jLabel25.setText("The Same Person Again");
        jPanel2.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 115, -1, 19));

        jLabel24.setBackground(new java.awt.Color(255, 255, 255));
        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(255, 255, 255));
        jLabel24.setText("When you are done");
        jPanel2.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, -1, 19));

        jLabel26.setBackground(new java.awt.Color(255, 255, 255));
        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 255, 255));
        jLabel26.setText("Click on the button");
        jPanel2.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, -1, 19));

        jLabel27.setBackground(new java.awt.Color(255, 255, 255));
        jLabel27.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(255, 255, 255));
        jLabel27.setText("below To Finish Voting");
        jPanel2.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, -1, 19));

        jLabel28.setBackground(new java.awt.Color(255, 255, 255));
        jLabel28.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jLabel28.setForeground(new java.awt.Color(255, 255, 255));
        jLabel28.setText("Girls");
        jPanel2.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 452, 123, 76));
        ...
        jPanel2.add(btnNextPage, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 546, 172, 41));
        ...
        jPanel2.add(lblTotalVotedFor, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 270, 70));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 77, 280, 590));
        ...
        lblMainMessage.setText("Vote - Girls - Page 1 / 1");
        jPanel3.add(lblMainMessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1100, 49));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1095, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -2, 1090, 680));
...
int totalSelected = 0;
    ...
    private void btnNextPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextPageActionPerformed
        ...
        if (!(activeVotes > votesAllowed)) {
            this.saveVotingData();
            if (cm.hasSecondVote(grade) == true && cm.usedFirstVote() == false && (!originalGrade.equalsIgnoreCase("Teacher"))) {
                ...
                cm.saveToSmartDisplay(cm.getActiveUserName() + " " + cm.getActiveUserSurname());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainVoteSystemGirls.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void loadAllData() { // method loads all appropriate text into the buttons and sets them visable if they should have text
        ...
        try {
            ...
            while (scFile.hasNextLine()) {
                ...
                scLine.close();
                if (grade.equalsIgnoreCase(UserGrade) && UserGender.equalsIgnoreCase("f")) {
                    fNameArr[size] = fName;
                    sNameArr[size] = sName;
    ...
    public void saveVotingData() //This will get all true booleans
    {
//        ao.removeActiveComputer();
        String allVotes;
        String userToAdd;
        ...
        try {
            ...
            if (nextPage == false) {
                PrintWriter oldUser = new PrintWriter(new FileWriter(cm.getLocalStorageLocation() + "\\OldUser.db"));
                oldUser.print(cm.getActiveUserName() + " " + cm.getActiveUserSurname());
                oldUser.close();
                Scanner saveVotedFor = new Scanner(new File(cm.getLocalStorageLocation() + "\\activeUserVotedFor.db")); // fixed bug where user would not always get loaded
                if (saveVotedFor.hasNext()) {

                    String lineMain = saveVotedFor.nextLine();
                    saveVotedFor.close();

                    lineMain = lineMain.replaceAll("- -", ", ");
                    lineMain = lineMain.replaceAll("- ", "");
                    lineMain = lineMain.replaceAll("-", "");
                    String extraDetail = "";
                    if (cm.usedFirstVote() == true) {
                        extraDetail = ", ";
                    }
                    SmartEncryption se = new SmartEncryption();
                   
                    String query;
                    if (sm.checkStatus("TrackVotedFor") == true) {
                        spp.addSqlStatement("update", "UPDATE UsersAlreadyVoted SET VotedFor = CONCAT(IFNULL(VotedFor, ''), \"" + extraDetail + "" + lineMain + "\") WHERE fName = \"" + cm.getActiveUserName() + "\" AND Surname = \"" + cm.getActiveUserSurname() + "\"");

                    } else {
                        spp.addSqlStatement("update", "UPDATE UsersAlreadyVoted SET VotedFor = \"" + "Tracking Not Enabled" + "\" WHERE fName = \"" + cm.getActiveUserName() + "\" AND Surname = \"" + cm.getActiveUserSurname() + "\"");

                    }

                } else {
                    System.out.println("User did not vote for any one");
                }
    ...
    private void loadNextPageNames() { //TODO DISABLE
        try {
            ...
            String query = "SELECT * FROM UsersToVoteFor WHERE Grade = \"" + grade + "\" AND Gender = \"f\"";
            result = stmt.executeQuery(query);
            String dbfName = "";
            String dbSurname = "";
            for (int i = 0; i < 30; i++) {
    ...
    private void loadTotalPages() {
        try {
            ...
            if (result.next()) {
                lblMainMessage.setText("Vote - Girls - Page 1 / 2");
            }
            for (int i = 0; i < 30; i++) {
                result.next();
            }
            if (result.next()) {
                lblMainMessage.setText("Vote - Girls - Page 1 / 3");
            }
